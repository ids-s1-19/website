...
- You only need to show up for the period you're assigned to (12-13 or 13-14) -- make sure to be there on the hour!
- When you come in pick up your evaluation sheet and take a seat. 
- We will start presentation after just a couple minutes of introductory remarks.
- Presentations will be off of my computer, using the link to your presentation on the README of your repository. 
- You will have a handheld mic you can pass between presenters, please use the mic. 

---

## Evaluating other teams

Out of 5 points. Score each of the following on a 0/1 scale, add up scores, and go to webform *after* class to enter your scores.
...
.instructions[
You **must** enter your scores by 17:00 on Wednesday to receive your own score. Otherwise you get a 0 on the "classmate's evaluation" portion of your project. URL to be provided tomorrow.
]
...
Same team peer evaluation process as before, with one additional question asking you to score your teammates (not yourself) on a scale of 0-10.

- Intellectual contribution
- Presence (physical and mental) during team meetings
- Presentation

.instructions[
You **must** enter your scores by 17:00 on Wednesday to receive your own score. Otherwise you get a 0 on the "team peer evaluation" portion of your project. Opens tomorrow.
]

---

```{r echo=FALSE, fig.align="center",out.width=700}
knitr::include_graphics("img/presentation-schedule.png")
```
...
.center[
.tiny[
[github.com/ids-s1-19/team-assignments/blob/master/project-presentation-schedule.csv](https://github.com/ids-s1-19/team-assignments/blob/master/project-presentation-schedule.csv)
]
]

---

## How are we evaluating you?

.small[
- **Content:** Is the research question well designed and is the data being used relevant to the research question? (0 - 5)
...
- Option 1: Building interactive web apps in R
- Option 2: Text analysis in R (song lyrics, books, etc.)
