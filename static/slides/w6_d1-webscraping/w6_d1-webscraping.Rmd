...
- Web scraping, and automating it via the use of functions and iterations
- ... the latter of which is a topic we'll revisit many times over the rest of 
the semester
- Team peer evaluations - due Wednesday
- Preparation for workshop tomorrow: make sure you have something, even if 
not full proposal, pushed to your repo for peer review
