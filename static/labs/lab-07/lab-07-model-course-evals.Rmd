...
In this week's workshop you will analyze the data from this study in order to start  
exploring what goes into a positive professor evaluation.
...
knitr::include_graphics("img/07-model-course-evals/data-upload.png")
```

- Click [here](http://www.introds.org/courses/Spring18/Sta199/labs/data/evals-mod.csv) to download the data. The file is called `evals-mod.csv`.
