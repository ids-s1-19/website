...
Click [here](https://rstudio.cloud/spaces/30501/join?access_code=AKjj1Ge4QUkPHSCdOd6vTdjF1h3TgyqzTNNzO%2Bbo) to join the RStudio Cloud workspace for this course.

Once you're in, click on "New project from Git" and paste the URL you copied from GitHub in there. Enter your GitHub username and password, and you're good to go!

## 3. Get working!

Open the R Markdown (Rmd) file called `lab-01-hello-r.Rmd`.
...
- If you click on a file, it will open in the editor, on the top right pane.

- Finally, the top left pane shows your Environment. If you define a variable it would show up there. Try typing `x <- 2` in the Console and hit enter, what do you get in the Environment pane? Importantly, this pane is also where the Git interface lives. We will be using that regularly throughout this lab.
...
This prints out only the top 10 rows. If you want to see all correlation coefficients, use the following:
