---
title: "Lab 10 - Collaborating on GitHub"
output: 
  tufte::tufte_html:
    css: ../lab.css
...
This week you'll continue working on your projects. The first half of the workshop 
is structured, and you can use the second half to make progress on your 
projects.
...
default theme you had to begin with), go to the `config.yml` file in your repo 
on RStudio and edit the theme name in the `config.yml` file. For example, if 
...
15. **Confirming schedules:** Go to the [schedule for presentations](https://github.com/ids-s1-19/team-assignments/blob/master/project-presentation-schedule.csv) and 
...
lab. **Presentations will be held in JCMB 5327.**
  ...
  So please make sure to leave your workshop by 11:30 at the lastest to get to 
