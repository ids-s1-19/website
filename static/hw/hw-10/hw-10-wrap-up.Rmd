...
Once again we'll read in the data using the following:
...
Once again, the dataset will be `.gitignore`d due to its size.

Remember that the GSS asked respondents how many hours and minutes they spend on 
...
# Part 3 - Make the ugliest ggplot you can!
